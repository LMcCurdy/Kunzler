...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    wp_register_script( 'bones-modernizr', get_template_directory_uri() . '/library/js/libs/modernizr.custom.min.js', array(), '2.5.3', true );
    ...
    wp_register_script( 'velocity', '//cdn.jsdelivr.net/velocity/1.2.2/velocity.min.js', array(), '', true );
    wp_register_script( 'velocityui', '//cdn.jsdelivr.net/velocity/1.2.2/velocity.ui.min.js', array(), '', true );
    wp_register_script( 'fastclick', '//cdnjs.cloudflare.com/ajax/libs/fastclick/1.0.6/fastclick.js', array(), '', true );
    wp_register_script( 'mmenu', '//cdnjs.cloudflare.com/ajax/libs/jQuery.mmenu/5.1.2/js/jquery.mmenu.min.js', array('jquery'), '', true );
    wp_register_script( 'owl', get_template_directory_uri() . '/assets/js/owl-carousel/owl.carousel.min.js', array('jquery'), '12192014', true );
    wp_register_script( 'responsive-slides', get_template_directory_uri() . '/assets/js/responsive-slides.js', array('jquery'), '12192014', true );
    ...
    wp_register_style( 'fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', array(), '', 'all' );
    wp_register_style( 'mmenu', '//cdnjs.cloudflare.com/ajax/libs/jQuery.mmenu/5.1.2/css/jquery.mmenu.css', array(), '', 'all' );
...
function ajax_filter_posts_scripts() {
    ...
    if (is_page_template('templates/page-photo-gallery.php')) {
        
      // Enqueue script
      wp_register_script('afp_script', get_template_directory_uri() . '/assets/js/ajax-filter-posts.js',  array( 'jquery','velocity','velocityui' ), null, false);
...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			'top-nav'    => __( 'Top Tier', 'bonestheme' ),
			'main-nav'    => __( 'Main Menu', 'bonestheme' ),
			'mobile-nav'  => __( 'Mobile Menu', 'bonestheme' ),
            'footerlinks' => __( 'Footer Links', 'bonestheme' ),
            'pro-page-links' => __( 'Pro Page Links', 'bonestheme' )
		)
	);
